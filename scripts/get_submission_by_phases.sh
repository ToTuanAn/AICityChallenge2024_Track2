...
python -m torch.distributed.launch --nproc_per_node 1 \
                                    ...
                                    --rule_mode vehicle \
                                    --rule_config_path rules_engine/configs/rule_config.yaml \
                                    --load_internal_ckpt_phase_0 $vehicle_ckpt_path_0 \
                                    --load_internal_ckpt_phase_1 $vehicle_ckpt_path_1 \
                                    --load_internal_ckpt_phase_2 $vehicle_ckpt_path_2 \
                                    --load_internal_ckpt_phase_3 $vehicle_ckpt_path_3 \
                                    --load_internal_ckpt_phase_4 $vehicle_ckpt_path_4 \
                                    --save $vehicle_pred_path \
                                    --save_phase_0 $vehicle_pred_path_0 \
                                    --save_phase_1 $vehicle_pred_path_1 \
                                    --save_phase_2 $vehicle_pred_path_2 \
                                    --save_phase_3 $vehicle_pred_path_3 \
                                    --save_phase_4 $vehicle_pred_path_4 
