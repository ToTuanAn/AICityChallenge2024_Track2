...
from ...constants import NUM_CAMERA_VIEWS
...
def build_multiview_ensembler(hidden_size, delay_load=False, **kwargs):
    multiview_ensembler = MultiViewEnsembler(hidden_size=hidden_size, 
                                             n_heads=4,
                                             dropout=0.1,
                                             feedforward_dim=hidden_size * 2,
                                             num_views=NUM_CAMERA_VIEWS, 
                                             num_frames=NUM_VIDEO_FRAMES) 
    return multiview_ensembler
